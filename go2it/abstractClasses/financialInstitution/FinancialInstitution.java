...
public class FinancialInstitution {
    ...
    public FinancialInstitution(String title,String bankAccNumber){
        System.out.println ("creating financial institution with parameters" );
        this.title = title;
    ...
    public String toString() {
        return "FinancialInstitution{"+"title='"+ title + '\''+",bankAccNumber=' "+",yearOfCreation="+yearOfCreation+'}';
    }
    ...
    @Override
    public int hashCode(){return Objects.hash (title,bankAccNumber);}
}
